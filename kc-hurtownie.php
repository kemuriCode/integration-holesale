 ...
 */
define('KC_HURTOWNIE_VERSION', '1.0.1');

/**
 * Tryb testowy dla importerów.
 * Jeśli włączony, importery będą używać przykładowych danych zamiast pobierać dane z API.
 */
define('KC_HURTOWNIE_TEST_MODE', false);
